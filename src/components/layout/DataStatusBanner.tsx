...
export function DataStatusBanner({ info }: { info: DataSourceInfo }) {
  ...
  return (
    ...
    >
      <div className="container-shell flex flex-col gap-2 py-3 text-sm font-semibold md:flex-row md:items-center md:justify-between">
        <p>
          {isLive ? (
            <>
              <span className="mr-2 inline-block rounded-[var(--radius-sm)] border-[2px] border-[var(--ink)] bg-white px-2 py-0.5">
                已连接
              </span>
